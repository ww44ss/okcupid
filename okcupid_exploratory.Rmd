...
Overall the number of men, `r n_males`, is about `r round(n_males/n_females, 1)` times greater than the number of females, `r n_females`. This ratio was carefully [not reported by OkCupid](https://blog.okcupid.com/index.php/the-case-for-an-older-woman/) in at least one analysis. There may be specificity of the geo-location of the data analyzed here ([San Francisco](http://visualizing.nyc/bay-area-zip-codes-singles-map/) only versus the larger OkCupid database as a whole). 
