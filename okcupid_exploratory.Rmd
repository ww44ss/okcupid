...
```{r, echo = FALSE}
profiles %>% colnames %>% print
```

##SUMMARY  
This explores several relationships listed below, including:
1. Religion and Drinking Habits.
2. Drinking Habits with Age.
3. Ages of OkCupid users. 
