...
This "MFH" is (values in italics are computed) is an ethnically *`r profiles %>% select(ethnicity) %>% table() %>% table_max()`* *`r profiles %>% select(sex) %>% table() %>% table_max() %>% gsub("m", "male", .)`* who ascribes to *`r profiles %>% select(religion) %>% table() %>% table_max()`*.   
  
They have  *`r profiles %>% select(education) %>% table() %>% table_max()`*, are *`r profiles %>% select(age) %>% table() %>% table_max()`* years old, drink *`r profiles %>% select(drinks) %>% table() %>% table_max()`*, just say *`r profiles %>% select(drinks) %>% table() %>% table_max()`* to drugs, and have an *`r profiles %>% select(body_type) %>% table() %>% table_max()`* body type.   
  
They eat *`r profiles %>% select(diet) %>% table() %>% table_max()`*, live in *`r profiles %>% select(location) %>% table() %>% table_max()`*, and have a *`r profiles %>% select(orientation) %>% table() %>% table_max()`* sexual orientation.  
   
They earn *\$`r profiles %>% select(income) %>% table() %>% table_max()`* per year, speaks *`r profiles %>% select(speaks) %>% table() %>% table_max()`*, is a *`r profiles %>% select(sign) %>% table() %>% table_max()`*, and though *`r profiles %>% select(offspring) %>% table() %>% table_max()`* they *`r profiles %>% select(pets) %>% table() %>% table_max()`*
